...
jQuery(document).ready(function($)
{
	...
	*/
    ...
    function initIsotopeFiltering()
    {
    	...
    	if($('.cat_product-grid').length)
    	{
    		$('.cat_product-grid').isotope({
    			itemSelector: '.cat_product-item',
	            getSortData: {
	        ...
	        sortTypes.each(function()
	        {
	        	$(this).on('click', function()
	        	{
    				...
    				$('.cat_product-grid').isotope( option );
	        	});
	        });
	        ...
	        sortNums.each(function()
	        {
	        	$(this).on('click', function()
	        	{
    				...
    				$('.cat_product-grid').isotope({filter: numFilter });
	        	});
	        });	
