			...
			<div class="col product_section clearfix">
				...
				<div class="breadcrumbs d-flex flex-row align-items-center">
					<ul>
						...
						<li class="active"><i class="fa fa-angle-right" aria-hidden="true"></i>Все товары <button class="btn btn-primary">{{ $brand->name }}</button> бренда</li>
					</ul>
				</div>
								...
								<div class="cat_product-grid">
									...
									@else
										...
										<div class="alert alert warning"> 
											У данного бренда нет продуктов :(
										</div>
